        ...
        <AnimatePresence>
          {menuOpen && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -10 }}
              transition={{ duration: 0.3 }}
              className="md:hidden bg-green-700 text-white px-6 py-4 space-y-3 shadow-lg w-full min-h-screen overflow-y-auto flex flex-col items-start"
            >
              <Link href="/" className={navLinkClass} onClick={() => setMenuOpen(false)}>
                <HomeIcon className="w-4 h-4" /> Home
              </Link>
              <Link href="/shop" className={navLinkClass} onClick={() => setMenuOpen(false)}>
                <ShoppingBag className="w-4 h-4" /> Shop
              </Link>
              ...
              <div className="flex flex-wrap items-center gap-3 mt-3">
                <button
                  ...
                  className="flex items-center gap-2 bg-green-600 px-3 py-2 rounded-full w-fit shadow cursor-pointer hover:bg-green-700 transition"
                >
