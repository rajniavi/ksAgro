...
export default function CustomerForgotPassword() {
  ...
  return (
    <div className="min-vh-100 d-flex align-items-center justify-content-center bg-gradient-to-br from-green-100 via-white to-green-200 px-3 py-5">
      {/* Main Card */}
      <motion.div
      ...
      >
        {/* Title */}
        <h1 className="text-3xl fw-bold text-center text-success mb-3">
          Forgot Password
        </h1>
        ...
        <form onSubmit={handleReset} className="d-flex flex-column gap-3">
          <motion.input
            ...
            type="email"
            placeholder="Email"
            className="form-control py-2 border border-success-subtle rounded-3 shadow-sm focus:ring-2 focus:ring-green-500"
            value={email}
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="btn btn-success py-2 fw-semibold rounded-3 shadow-sm d-flex align-items-center justify-content-center gap-2"
          >
            {loading ? (
              <>
                <span
